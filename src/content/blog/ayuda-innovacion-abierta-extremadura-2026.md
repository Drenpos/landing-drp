---
title: "Ayudas de innovación abierta en Extremadura: hasta 25.000 € al 100% para digitalizar tu pyme"
meta_title: "Ayudas innovación abierta Extremadura 2026: 25.000 € por pyme"
description: "Convocatoria 2026 abierta del 18 de julio al 18 de agosto: subvención del 100% hasta 25.000 € para pymes de Extremadura que resuelvan un reto con una startup. Requisitos, baremo y cómo ganar puntos."
date: 2026-07-17
image: "/images/blog/ayudas-innovacion-abierta-extremadura/cover.jpg"
author:
  name: "Alonso Bermejo Pérez"
  designation: "CEO & Founder"
  avatar: "/images/alonso.jpg"
categories:
  ["Ayudas y Subvenciones", "Gestión Empresarial", "Tecnología para PYMES"]
tags:
  [
    "ayudas innovación abierta Extremadura",
    "subvención pymes Extremadura",
    "pyme tractora",
    "startup certificada ENISA",
    "Decreto 36/2025",
    "convocatoria 2026",
    "Drenpos",
  ]
...
hero:
  ...
  description: "Convocatoria 2026 abierta del 18 de julio al 18 de agosto. La Junta financia la solución tecnológica que tu negocio necesita y que no existe en el mercado."
faq:
  - question: "¿Cuánto dinero da la ayuda de innovación abierta de Extremadura?"
    answer: "La subvención cubre el 100% del coste del proyecto hasta un máximo de 25.000 € por proyecto (IVA excluido), a fondo perdido. Se cobra en dos pagos: el 50% se anticipa al recibir la resolución de concesión y el 50% restante al justificar la ejecución de al menos el 40% del proyecto."
  - question: "¿Quién puede solicitar las ayudas de innovación abierta?"
    answer: "Pymes con forma societaria (S.L., S.A., cooperativa) y centro de trabajo en Extremadura que tengan un reto sin solución en el mercado y hayan firmado un acuerdo de colaboración previo con una startup o Empresa de Base Tecnológica. Los autónomos no pueden ser pyme tractora, pero sí actuar como startup que desarrolla la solución."
  - question: "¿Cuál es el plazo de la convocatoria 2026?"
    answer: "La convocatoria 2026 está abierta del 18 de julio al 18 de agosto de 2026, un mes desde su publicación en el DOE n.º 137 de 17 de julio. La dotación es de 500.000 €, el doble que en 2025, y las solicitudes se presentan electrónicamente en la sede de la Junta de Extremadura."
  - question: "¿Qué gastos cubre la subvención?"
    answer: "Cubre los servicios de consultoría externa especializada en innovación que presta la startup o EBT para desarrollar la solución al reto, hasta 25.000 € (IVA excluido). No cubre hardware, licencias de software estándar ni personalizaciones de productos comerciales ya existentes: se financia lo que se crea, no lo que se configura."
  - question: "¿Es compatible con otras subvenciones?"
...
## ¿Qué requisitos debe cumplir tu pyme para acceder a la subvención?

Para acceder a la ayuda tu empresa debe cumplir cuatro condiciones: tener forma societaria (S.L., S.A. o cooperativa; los autónomos no pueden ser pyme tractora), disponer de centro de trabajo en Extremadura al que se refiera el reto, no operar en un sector excluido (pesca, producción agraria primaria, juego, finanzas o tabaco) y haber firmado un acuerdo de colaboración con la startup o EBT antes de presentar la solicitud.

![Equipo de una pyme revisando su operativa de almacén con tablet en mano.](/images/blog/ayudas-innovacion-abierta-extremadura/section-1.jpg)

- **Forma societaria:** S.L., S.A., cooperativa o similar. Los autónomos no pueden ser pyme tractora (aunque sí pueden actuar como startup que desarrolla la solución).
- **Centro de trabajo en Extremadura:** el reto debe estar referido a ese centro y generar impacto positivo en la región.
- **Sector no excluido:** quedan fuera pesca y acuicultura, producción agraria primaria, juego y apuestas, actividades financieras y tabaco. El comercio, la distribución, la hostelería, la industria o los servicios entran sin problema.
- **Un reto real sin solución en el mercado:** la necesidad debe ser concreta y no estar cubierta por ningún producto comercial existente.
...
Las ayudas se conceden por concurrencia competitiva: los proyectos se puntúan sobre 100 puntos (más 10 adicionales si la startup está certificada por ENISA) y las solicitudes que no alcanzan 50 puntos se deniegan directamente. El criterio que más pesa es la adecuación y concreción del reto (35 puntos), seguido del grado de innovación (25). Entender el baremo antes de redactar la memoria es la diferencia entre conseguir la subvención y quedarte en lista de espera.

| Criterio de valoración                                     | Puntos máximos | Cómo se gana                                                               |
| ---------------------------------------------------------- | -------------- | -------------------------------------------------------------------------- |
| Adecuación y alcance del reto                              | 35             | Definición concreta del problema y encaje con la estrategia de la empresa  |
| Grado de innovación                                        | 25             | Valor diferencial frente al estado de la técnica                           |
| Recursos humanos y materiales                              | 15             | Calidad del equipo de la pyme y de la startup                              |
| Maduración previa (Extremadura Open Innovation o similar)  | 10             | Participar en programas de innovación abierta antes de solicitar           |
...
- **10 puntos automáticos** en la valoración por nuestro sello ENISA, comprobados de oficio por la administración, sin papeleo adicional.
...
El plazo de la convocatoria 2026 va del 18 de julio al 18 de agosto de 2026: un mes desde la publicación de la resolución en el DOE. La dotación asciende a 500.000 €, suficiente para una veintena de proyectos. La solicitud se presenta electrónicamente con certificado digital, acompañada de la memoria del reto (máximo 15 páginas), el acuerdo de colaboración firmado, la factura proforma de la startup y la declaración de ausencia de conflicto de interés.
...
### ¿Cuánto dinero da la ayuda de innovación abierta de Extremadura?

La subvención cubre el 100% del coste del proyecto hasta un máximo de 25.000 € por proyecto (IVA excluido), a fondo perdido. Se cobra en dos pagos: el 50% se anticipa al recibir la resolución de concesión y el 50% restante al justificar la ejecución de al menos el 40% del proyecto.

### ¿Quién puede solicitar las ayudas de innovación abierta?

Pymes con forma societaria (S.L., S.A., cooperativa) y centro de trabajo en Extremadura que tengan un reto sin solución en el mercado y hayan firmado un acuerdo de colaboración previo con una startup o Empresa de Base Tecnológica. Los autónomos no pueden ser pyme tractora, pero sí actuar como startup que desarrolla la solución.

### ¿Cuál es el plazo de la convocatoria 2026?

La convocatoria 2026 está abierta del 18 de julio al 18 de agosto de 2026, un mes desde su publicación en el DOE n.º 137 de 17 de julio. La dotación es de 500.000 €, el doble que en 2025, y las solicitudes se presentan electrónicamente en la sede de la Junta de Extremadura.

### ¿Qué gastos cubre la subvención?

Cubre los servicios de consultoría externa especializada en innovación que presta la startup o EBT para desarrollar la solución al reto, hasta 25.000 € (IVA excluido). No cubre hardware, licencias de software estándar ni personalizaciones de productos comerciales ya existentes: se financia lo que se crea, no lo que se configura.

### ¿Es compatible con otras subvenciones?

No. Es incompatible con otras subvenciones a fondo perdido para la misma actuación. Además tiene consideración de ayuda de minimis: el total de ayudas de minimis recibidas por una empresa no puede superar los 300.000 € en cualquier período de tres años, según el Reglamento (UE) 2023/2831.

---

_Ayudas reguladas por el Decreto 36/2025, de 6 de mayo (DOE n.º 94, de 19 de mayo de 2025). Convocatoria 2026 aprobada por Resolución de 30 de junio de 2026 (DOE n.º 137, de 17 de julio de 2026), con una dotación de 500.000 € cofinanciada al 85% por el Programa Extremadura FEDER 2021-2027. Concesión en régimen de concurrencia competitiva, sujeta a la normativa de minimis. La obtención de la ayuda depende de la resolución del órgano concedente._
