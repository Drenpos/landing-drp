...
- [¿A quién afecta y desde cuándo?](#a-quien-afecta)
- [VERI\*FACTU vs “no verificable”: pros y contras](#comparativa)
- [Requisitos clave: QR y leyenda «VERI\*FACTU»](#qr)
- [Sanciones y riesgos de incumplir](#sanciones)
- [Cómo adaptarte con seguridad (checklist en 10 pasos)](#checklist)
- [Preguntas frecuentes](#faqs)
- [Conclusión y siguiente paso](#conclusion)

<h2 id="que-es">Qué es VERI*FACTU (versión clara y sin tecnicismos)</h2>
...
![Diagrama VERI*FACTU: TPV/ERP → Registro de facturación → Remisión segura AEAT → Confirmación y trazabilidad](# "Esquema de flujo de datos desde Drenpos (emisión) hasta AEAT (recepción), destacando envío automático y sellos de trazabilidad.") -->

<h2 id="qr">Requisitos clave: QR y leyenda «VERI*FACTU»</h2>
...
![Detalle de factura con QR y leyenda VERI*FACTU](/images/blog/verifactu/verifactu-qr.webp)

<h2 id="sanciones">Sanciones y riesgos de incumplir</h2>
...
<h2 id="checklist">Cómo adaptarte con seguridad (checklist en 10 pasos)</h2>
...
![Panel Drenpos “Resumen de envíos VERI*FACTU”](/images/blog/verifactu/verifactu-drenpos-traza.webp) ![Panel Drenpos “Resumen de envíos VERI*FACTU”](/images/blog/verifactu/verifactu-drenpos-review.webp)
