...
> "Un Excel compartido no es un registro horario digital. Es un documento editable que puede perjudicarte más que protegerte ante una auditoría."
...
**Terminal de fichaje en local:** Dispositivo físico instalado en la entrada del establecimiento. Permite fichar mediante tarjeta NFC, código PIN o código QR. Adecuado para equipos que trabajan siempre en el mismo centro.

**Código QR geolocalizado:** El empleado escanea un QR único asignado a su puesto de trabajo. Combina sencillez con verificación de ubicación. Funciona tanto desde móvil como desde tableta compartida.

**Portal web:** Fichaje desde navegador, sin necesidad de instalar ninguna app. Útil para trabajadores de oficina que siempre operan desde el mismo ordenador.
...
- **Infracciones graves**: entre 751 y 7.500 euros por trabajador. Entran aquí la falta de sistema adecuado, la conservación incompleta de registros y el uso de sistemas no homologados
- **Infracciones muy graves**: entre 7.501 y 225.018 euros por trabajador, reservadas para manipulación o falsedad en los datos

**Ejemplo real:** Una empresa de hostelería con 15 empleados que sigue usando papel podría enfrentarse a una sanción grave de hasta 7.500 euros por cada uno de los 15 trabajadores. Total: hasta 112.500 euros por una única inspección.
...
- Ausencia total de sistema de registro

**Las sanciones no son el único riesgo.** Un trabajador que demuestre que sus horas extra no fueron registradas puede reclamar su abono retroactivo con intereses. Sin un sistema de trazabilidad digital, la empresa no tiene pruebas para refutar la reclamación.
...
**1. Auditoría del sistema actual.** Identifica qué datos se registran ahora, dónde se almacenan y quién los gestiona. Localiza los puntos donde la información se pierde o se altera.

**2. Elección del método de fichaje.** Decide qué sistema se adapta mejor a tu operativa: app móvil para equipos en campo, terminal físico para locales fijos, portal web para oficinas. Un sistema como Drenpos permite combinar varios métodos en función del puesto.

**3. Migración e integración con nóminas.** Los datos de jornada deben fluir directamente hacia el cálculo de nóminas sin exportaciones manuales. Si tienes que copiar datos entre sistemas, estás generando puntos de fuga y riesgo de error.

**4. Formación mínima y periodo de prueba.** El fichaje debe ser un gesto de tres segundos, no un procedimiento. Si el equipo necesita instrucciones cada vez que va a fichar, el sistema no está bien implantado.

> "La implementación correcta no la notas. El empleado ficha, el sistema registra, el responsable audita. Sin fricción, sin errores, sin riesgo."
...
- **Informar por escrito** a cada trabajador sobre qué datos se recogen, con qué finalidad, durante cuánto tiempo se conservan y quién puede acceder a ellos
- **Establecer la base jurídica del tratamiento**: en el caso del registro horario es el cumplimiento de una obligación legal (art. 6.1.c RGPD)
- **Garantizar el derecho de acceso**: el trabajador puede solicitar sus registros en cualquier momento
- **Implementar medidas de seguridad** que impidan accesos no autorizados, tanto internos como externos

Si el sistema incluye geolocalización, la información previa al trabajador debe ser especialmente explícita sobre cuándo se activa y con qué precisión se registra la ubicación.
...
Sí. La obligación aplica a cualquier empresa con trabajadores por cuenta ajena, independientemente del tamaño o sector. El autónomo que tiene uno o más empleados contratados debe llevar registro de su jornada.

### ¿Puedo usar una app gratuita para cumplir la normativa?

Depende. Una app gratuita puede ser válida si garantiza inalterabilidad de los datos, acceso del trabajador, conservación durante cuatro años y facilidad de exportación para la Inspección. El problema es que la mayoría de soluciones gratuitas no cubren todos estos requisitos ni ofrecen integración con nóminas o garantías de soporte ante cambios normativos.

### ¿Qué ocurre si un empleado olvida fichar?

El sistema debe disponer de un protocolo de corrección: el trabajador notifica el olvido, el responsable valida y autoriza la corrección, y el sistema registra el cambio con fecha, hora y persona que lo autorizó. Sin este rastro, cualquier modificación puede ser considerada manipulación.

### ¿El registro horario digital vale para el teletrabajo?

Sí, y es especialmente importante. El trabajador en remoto debe registrar entrada, salida, pausas y horas extra exactamente igual que uno presencial. La app móvil o el portal web permiten hacerlo desde cualquier ubicación, y la geolocalización puede configurarse para verificar que el fichaje se realiza desde una ubicación coherente.

### ¿Cuánto tiempo hay que conservar los registros?

El plazo legal mínimo es de **cuatro años**. Los registros deben estar disponibles para la Inspección de Trabajo, para los representantes de los trabajadores y para el propio empleado durante ese período.
